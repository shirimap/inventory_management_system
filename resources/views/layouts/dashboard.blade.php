                    ...
                    <div class="info-box bg-dark">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                ...
                                <small class="pull-right"><a href="{{ route('mauzomuuzaji') }}"
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box bg-dark">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <h4>{{ number_format($faida,2)}} <sup style="font-size: 12px"> TZS</sup></h4>
                                <small class="pull-right"><a href="#" class="small-box-footer">More info <i
                                            class="fas fa-arrow-circle-right"></i></a></small>
                            </span>
                        </div>
                    ...
                    <div class="info-box bg-dark">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                ...
                                <small class="pull-right"><a href="{{ route('madeni') }}" class="small-box-footer">More
                                        info <i class="fas fa-arrow-circle-right"></i></a></small>
                            </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
